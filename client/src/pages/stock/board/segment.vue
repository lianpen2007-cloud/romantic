    ...
    <div class="c-segment">
        <div class="charts">
            <div class="chart_wrapper">
                <div id="segment_price" class="chart" />
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    async mounted() {
        this.chart = echarts.init(document.getElementById('segment_price'))
    ...
    methods: {
        paint() {
            ...
            document.getElementById('segment_price').style.height = height + 'px'
            const width = Math.max(this.mergedKLineList.length * 10, 800)
            document.getElementById('segment_price').style.width = Math.max(document.body.clientWidth, width) + 'px'
            this.drawchart()
        },
        drawchart() {
...
<style>
.c-segment .charts .chart_wrapper {
    width: 100%;
    overflow-x: scroll;
}
.c-segment .charts .chart {
    width: 100%;
    height: 440px;
    margin-top: -40px;
}
.c-segment .charts .volumn_chart {
    width: 100%;
    height: 220px;
    margin-top: -100px;
    position: relative;
